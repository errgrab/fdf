...
/*   Updated: 2024/03/03 01:16:50 by ecarvalh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_shape(t_fdf *fdf, int **points, int **edges)
{
	...
	while (edges[++i])
	{
		line[0][X] = points[edges[i][0]][X];
		line[0][Y] = points[edges[i][0]][Y];
		line[1][X] = points[edges[i][1]][X];
		line[1][Y] = points[edges[i][1]][Y];
